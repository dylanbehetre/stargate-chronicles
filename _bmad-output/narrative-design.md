...
## Fondations Narratives

### Prémisse Narrative

Le joueur prend les commandes d'un programme secret qui va chambouler le rapport de
l'humanité à l'immensité de l'Univers. Que nous réserve cet anneau découvert à Gizeh ?
Le joueur gardera-t-il les commandes — et l'humanité survivra-t-elle ?

Un général apprécié du président prend la tête du Programme de la Porte des Étoiles :
envoyer des équipes dans l'inconnu absolu, forger des alliances fragiles avec des civilisations
millénaires, et tenir la Terre debout face à des menaces que personne ne peut comprendre —
ni encore moins anticiper.

---

### Thèmes Centraux

1. **Découverte & Exploration** *(thème dominant)*
   Chaque activation de la Porte est un saut dans l'inconnu. La connaissance est le vrai
   moteur du programme — et son plus grand danger.

2. **Amélioration & Maturation Continue**
   Le SGC apprend, se renforce, se réorganise. Les équipes grandissent. Les technologies
   évoluent. L'humanité avance à tâtons vers son destin galactique.

3. **Identité & Appartenance**
   Qui sommes-nous face à des civilisations vieilles de millions d'années ? Que signifie
   être Tau'ri dans une galaxie qui nous ignore ou nous méprise ?

4. **Héritage & Transmission**
   Ce que le SGC construit ne lui appartient pas — c'est le fondement de ce que l'humanité
   laissera dans la galaxie. Chaque alliance forgée, chaque planète libérée, s'inscrit dans
   un récit plus grand que soi.

5. **Menace Existentielle Permanente**
   La Terre n'est jamais vraiment en sécurité. Les System Lords, les Réplicateurs, les Ori
   — chaque ère apporte sa propre extinction potentielle. Le programme existe parce que
   l'alternative est l'annihilation.

---

### Ton & Atmosphère

**Ton :** Aventure épique (60%) + Responsabilité du commandement (40%)

**Atmosphère :** Ancré dans le réalisme militaro-scientifique de SG-1 — ni cynique, ni
naïf. L'émerveillement est toujours possible, même dans les moments les plus sombres.
Le joueur ressent le poids de chaque décision mais aussi le souffle de chaque découverte.

**Registre Émotionnel de Référence :**
- *La découverte des coordonnées d'Atlantis* — émerveillement pur, horizon qui s'ouvre
  sur l'infini
- *La rencontre avec les Asgards* — la révélation que nous ne sommes pas seuls, et que
  des êtres anciens nous regardent avec espoir

**Palette Émotionnelle :**
- Émerveillement scientifique et explorateur
- Tension du commandement (envoyer des hommes et des femmes au péril de leur vie)
- Camaraderie et victoires durement méritées
- Mélancolie des pertes et du poids de la connaissance
- Espoir persistant — l'humanité trouve toujours un chemin

---

### Identité du Général (Joueur)

**Type :** Hybride (Option C) — Le joueur crée/nomme son général, mais les décisions
forgent son identité narrative au fil du jeu. Le jeu reflète les choix dans la narration
("Votre général est réputé pour sa brutalité envers les traîtres", etc.).

**Genre :** Masculin ou féminin — au choix du joueur à la création.

**Backstory — "Le Gardien du Silence" :**
En 1969, lors d'une activation accidentelle de la Porte, le/la parent du général
—jeune officier de permanence cette nuit-là— vit ce qui se passa quelques secondes dans
l'anneau avant que tout soit coupé. Assez pour changer une vie. Assez pour ne plus jamais
dormir normalement. Il/elle finit sa carrière à rédiger des rapports de routine sur un
objet qu'il/elle savait vivant. Le général fut recruté(e) directement par ceux qui
cherchaient quelqu'un ayant *déjà* grandi avec ce secret — sans avoir à tout lui expliquer.

*Résonance canonique :* Le Général Hammond partage cette même fibre — il était lui aussi
ce jeune officier en 1969 (SG-1 S2E21). Hammond reconnaît le général sans qu'un mot
soit nécessaire : deux gardiens du même silence, deux décennies d'écart. L'héritage
"Hammond" est ainsi incarné dès la première scène du programme.

---

### Antagoniste Politique Récurrent — Kinsey

Le Sénateur/Secrétaire Kinsey est l'antagoniste humain permanent du programme. Il surgit
chaque fois qu'une mission tourne mal, que le budget explose, ou que la Terre est menacée
— convaincu que le SGC est une bombe à retardement plutôt qu'un bouclier.

**Déclencheurs d'intervention :**
- Seuil de Confiance Gouvernementale < 70% → première apparition (commentaires publics)
- < 50% (surveillance accrue — I01-1 : Kinsey à la Tribune)
- < 30% (audiences au Sénat — I01-2 : procédure de destitution)
- Incidents diplomatiques majeurs
- Pertes d'équipes médiatisables

Kinsey n'est pas un méchant simple — il a ses arguments. Parfois les événements lui
donnent raison. Sa présence renforce le thème "Responsabilité du Commandement" de façon
viscérale : l'ennemi le plus dangereux est parfois dans le même couloir.
...
- **Étapes** — événements internes à l'arc, chacun avec ses propres prérequis
- 🏁 **Conclusion** — résolution définitive, impact durable sur le monde du jeu
- ➡️ **Débloque** — arcs ou éléments de jeu rendus accessibles par la conclusion

| Catégorie | Préfixe | Contenu |
|---|---|---|
| 🔴 Antagonistes Voie Lactée | ARC-G | Factions ennemies, menaces existentielles |
| 🟡 Alliances & Grandes Races | ARC-A | Relations diplomatiques, civilisations alliées |
| 🔵 Internes & Politiques | ARC-I | Politique terrestre, technologie, événements spéciaux |
| 🌊 Pégase | ARC-P | Totalité des arcs de la galaxie de Pégase |

*→ Catalogue complet avec étapes et dépendances : section **Story Beats & Arcs Narratifs** ci-dessous.*

---

### Système de Transition Atlantis `[v2]`

> ⚠️ *Cette section décrit le contenu de la version 2. Elle est documentée ici pour la continuité narrative mais n'est pas dans le scope de développement v1.*

#### Personnages Narratifs d'Emblée dans l'Expédition

Deux personnages sont **introduits via des événements de base SGC** pendant les Arcs 2-3
(voir section ci-dessus) puis intégrés automatiquement à l'expédition Atlantis.
Le joueur les crée au moment de leur introduction narrative — ils sont ensuite réservés
pour l'expédition et ne comptent pas parmi les 6 membres supplémentaires à choisir.

**Le Scientifique Imposé** *(créé lors de l'événement "Le Scientifique Imposé", Arc 2-3)*
- Créé par le joueur (nom, apparence, stats libres avec archétype Scientifique suggéré)
- **Non disponible pour les équipes de terrain** — présent dans les événements de base
  et arcs narratifs ponctuels à la base ou en extérieur
- Archétype Scientifique INT-prioritaire ; sa relation avec l'équipe évolue de "génie
  insupportable" à "coéquipier irremplaçable" via ses arcs propres à Atlantis
- Bonus de nommage canonique Atlantis actifs à la création *(ex : "Rodney McKay" + Tau'ri)*

**Le Soldat à Gène ATA** *(créé lors de l'événement "Le Soldat au Gène Ancien", Arc 2-3)*
- Créé par le joueur (nom, apparence, stats libres avec archétype Combattant ou Commandant)
- **Aptitude Gène ATA naturel forcée** à la création
- Disponible pour les équipes de terrain SGC jusqu'à la transition, puis pour Atlantis
- Bonus de nommage canonique Atlantis actifs à la création *(ex : "John Sheppard" + Tau'ri)*

#### Composition de l'Expédition

Le joueur **crée ou choisit 6 membres supplémentaires** pour l'expédition Atlantis :
- Création de nouveaux membres avec bonus Atlantis actifs
- **OU** sélection de membres existants du SGC → migration **définitive et permanente**
  vers Atlantis (plus disponibles pour les équipes SG)
- *La séparation est ressentie : les équipes SG restantes ont un vide.*

**Genre :** Tous les membres créés — avatar, équipes SG, expédition Atlantis — peuvent
être masculins ou féminins, au choix libre du joueur.

#### Choix du Directeur de l'Expédition Atlantis

**Option A — Le Général prend le commandement d'Atlantis**
- Le général migre définitivement vers Atlantis
- Le joueur désigne un **Général de remplacement** pour le SGC parmi les membres
  existants (plus disponible pour les expéditions terrain)
- **Bonus création membres Atlantis :** +1 PHY, +1 HAB, +1 INS
- *Culture militaire — équipes formées à l'image d'un général de terrain*

**Option B — Création d'un nouveau Directeur Civil pour Atlantis**
- Le général reste à la tête du SGC
- Le joueur crée un **nouveau Directeur civil** dédié à l'expédition Atlantis
- **Bonus création membres Atlantis :** +1 HAB, +1 INT, +1 PER
- *Culture scientifique — équipes orientées recherche, exploration et diplomatie*

#### Bonus de Nommage Canonique

Si le joueur nomme un membre créé avec le nom exact d'un personnage canonique **ET** que
la race correspond, un bonus canonique se débloque. La race est obligatoire : nommer un
Tau'ri "Teal'c" ne déclenche rien — seul un Jaffa peut porter ce bonus.

Le bonus se compose de trois éléments cohérents avec le système GDD :
- **Preset suggéré** — distribution des 21 points libres optimisée pour le canon
- **Trait accordé** — le trait de création est fixé (pas tiré aléatoirement)
- **Aptitude/Condition** — certaines conditions normalement requises sont assouplies

**Personnages Canoniques SG-1**

| Nom | Race | Preset suggéré *(base 8 + 21 pts)* | Trait création | Aptitude / Note |
|---|---|---|---|---|
| **Teal'c** | Jaffa | Combattant — PHY 14, HAB 11, INS 13, VOL 12, PER 10, CHA 9, INT 8. Après racial Jaffa : PHY 16, INS 14, CHA 8 | Instinct de Terrain | "Signe de Caste" débloqué dès la 1ère mission *(condition PHY ≥ 15 déjà remplie via bonus racial — seul le compteur de missions reste)* — Easter Egg "Indeed" actif |
| **Daniel Jackson** | Tau'ri | Preset Archéologue standard — INT 14, PER 13, VOL 11, CHA 11, HAB 10, INS 10, PHY 8. Après racial : VOL 12 | Empathique | Easter Egg GDD existant : *arc archéologique exclusif* |
| **Samantha Carter** | Tau'ri | Preset Scientifique standard — INT 14, HAB 12, PER 12, VOL 10, CHA 10, INS 10, PHY 9. Après racial : VOL 11 | Méthodique | Gène ATA thérapeutique offert dès la 1ère recherche médicale *(condition de déblocage assouplied)* |
| **Jack O'Neill** | Tau'ri | Hybride — PHY 12, HAB 12, INS 13, VOL 11, CHA 11, PER 10, INT 8. Après racial : VOL 12 | Sang-froid | Gène ATA naturel **garanti** *(pas tiré aléatoirement — garanti à la création)* |
| **Bra'tac** | Jaffa | Combattant — PHY 14, HAB 11, INS 12, VOL 12, CHA 9, PER 10, INT 9. Après racial : PHY 16, INS 13, CHA 8 | Leader naturel | "Signe de Caste" débloqué dès la 1ère mission — Easter Egg *"Hammond de Texas"* actif |
| **Jacob Carter** | Tau'ri | Commandant diplomate — CHA 14, VOL 12, INT 12, PER 11, HAB 10, INS 10, PHY 8. Après racial : VOL 13 | Empathique | Aptitude "Symbiose Tok'ra" accordée dès l'Alliance Tok'ra active *(exception canonique : hôte Tau'ri — voir GDD §Aptitudes Spéciales)* |

**Personnages Canoniques Atlantis** `[v2]`
*(Bonus actifs uniquement si : création pour base Atlantis OU personnage narratif imposé. Scope v2.)*

| Nom | Race | Preset suggéré *(base 8 + 21 pts)* | Trait création | Aptitude / Note |
|---|---|---|---|---|
| **Rodney McKay** | Tau'ri | Scientifique max — INT 14, HAB 14, PER 11, VOL 12, PHY 9, INS 8, CHA 9. Après racial : VOL 13. *Archétype Scientifique forcé si personnage narratif* | Méthodique | Gène ATA thérapeutique immédiat *(sans délai de recherche)* + effet Méthodique étendu : recherche ×0,7 au lieu de ×0,9 |
| **John Sheppard** | Tau'ri | Preset Combattant standard — PHY 13, HAB 13, INS 12, PER 11, VOL 10, CHA 10, INT 8. *Archétype Combattant ou Commandant forcé si personnage narratif* | Instinct de Terrain | Gène ATA naturel **garanti** *(le plus fort porteur canonique)* |
| **Teyla Emmagan** | Athosien | PER/CHA/INS élevés — PER 13, CHA 12, INS 12, PHY 11, HAB 11, VOL 10, INT 8. Après racial Athosien : PER 14, CHA 13 | Empathique | Gène Wraith accordé à la **création** *(exception canonique — sang Wraith de Teyla ; normalement événement narratif rare)* |
| **Ronon Dex** | Satédan *(race v2 — voir GDD §Races jouables : +2 PHY, +1 INS, −1 CHA)* | PHY 14, INS 13, HAB 12, VOL 11, PER 10, CHA 9, INT 8. Après racial : PHY 16, INS 14 | Survivant | Aptitude "Traqué" *(voir GDD §Aptitudes Spéciales)* |
| **Elizabeth Weir** | Tau'ri | Commandant diplomate — CHA 14, INT 12, VOL 12, PER 11, HAB 10, INS 10, PHY 8. Après racial : VOL 13 | Empathique | Archétype Commandant + CHA 14 = accès immédiat à l'autorité diplomatique maximale |
| **Carson Beckett** | Tau'ri | Scientifique médical — INT 14, PER 12, HAB 11, VOL 11, CHA 11, INS 9, PHY 9. Après racial : VOL 12 | Méthodique | Gène ATA naturel **garanti** + aptitude "Médecin de Guerre" *(voir GDD §Aptitudes Spéciales)* |

*→ Race Satédan, aptitudes "Traqué" et "Médecin de Guerre" : ajoutées au GDD §Races jouables et §Aptitudes Spéciales (scope v2).*

---

#### Personnages Partagés & Arcs Croisés SGC / Atlantis

Comme dans la série, certains membres peuvent être présents dans les deux programmes
et participer à des arcs narratifs combinés impliquant les deux bases simultanément.

**Personnages Partagés :**
Certains membres créés pour le SGC peuvent être temporairement affectés à Atlantis
(et vice versa) lors d'événements narratifs spécifiques — sans migration définitive.
Ces affectations temporaires sont déclenchées par des arcs croisés et ne retirent pas
le membre de sa base d'origine une fois l'arc terminé.

**Arcs Narratifs Croisés :**
À certains moments clés de la progression, des événements narratifs combinent des
équipes des deux bases autour d'un objectif commun — une menace qui touche les deux
galaxies simultanément, une découverte qui nécessite des expertises des deux programmes,
ou une crise diplomatique impliquant des races connues dans les deux dimensions.
Ces arcs croisés sont cohérents avec la continuité de chaque base et respectent
l'avancement narratif propre à chacune.

---

## Story Beats & Arcs Narratifs

> **Convention de lecture :**
> - Les **Prérequis** d'une étape s'ajoutent toujours aux conditions de **Déblocage** de l'arc
...
**➡️ Débloque :** ARC-A02, ARC-A04, ARC-A05, ARC-I03 conditions
...
**➡️ Débloque :** ARC-P00, ARC-G05 conditions partielles
...
#### ARC-I03 — 1969, la Boucle du Silence

**🔓 Déblocage :** ARC-A01 étape 4 + Tempête solaire détectée *(événement aléatoire)*

| ID | Étape | Événement | Prérequis | Déclenche |
|---|---|---|---|---|
| I03-1 | Aller simple vers 1969 | Une tempête solaire renvoie SG-1 en 1969. Ils croisent un jeune officier qui reconnaît l'anneau pour ce qu'il est — et se tait. C'est peut-être le parent du général. *(S2E21)* | — | — |

**🏁 Conclusion :** Retour au présent. La boucle est bouclée. La backstory du général est confirmée ou infirmée selon les choix du joueur.

**➡️ Débloque :** Trait narratif permanent : *"Gardien du Silence confirmé"*
...
**➡️ Débloque :** Fusion SGC/Atlantis, fin du jeu Pégase
