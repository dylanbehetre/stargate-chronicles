...
> L'objectif est de garantir une cohérence visuelle totale entre tous les assets du jeu.
...
### 1. SGC / Installations Terrestres
> Bunker militaire souterrain, années 1997-2007. Brutalisme militaire américain.

| | Couleur | Hex |
|---|---|---|
| Primaire | Béton brut | `#2A2A2A` |
| Primaire | Vert militaire olive | `#4A5A3A` |
| Secondaire | Acier bleuté | `#3A4A5A` |
| Accent danger | Jaune avertissement | `#FFD700` |
| Accent énergie | Vert terminal | `#33FF33` |

**Mots-clés prompt** :
`military bunker interior, concrete walls, steel blast doors, SGC command center, 1990s military technology, underground base, cold fluorescent lighting, olive drab equipment, digital concept art, manhwa style bold outlines`
...
### Template Universel
```
[STYLE_BASE], [SUJET_PRINCIPAL], [LIEU/BIOME], [HEURE/AMBIANCE], 
[DÉTAILS_SPÉCIFIQUES], [COMPOSITION], [PRÉSENCE_HUMAINE],
...
massive ancient Stargate standing among sand dunes at sunset,
scorching orange-red sky with two visible moons, stone ruins half-buried,
heat shimmer rising from cracked ground, deep cold shadows contrasting warm sunlight,
two small SGC soldier silhouettes in BDU approaching the gate from behind,
rule of thirds composition, wide establishing shot, cinematic depth,
dramatic high contrast, no text, no watermark
```
...
crumbling stone temple of alien origin, massive overgrown carved stone blocks,
crepuscular golden light breaking through storm clouds, dramatic sky,
four SGC soldiers in silhouette exploring the ruins cautiously,
teal energy glyph faintly glowing on a stone pillar,
sense of wonder mixed with danger, deep shadows, rich amber and teal contrast,
cinematic composition, rule of thirds, atmospheric depth,
no text, no watermark
```

---

## 🚫 Negative Prompts (À toujours inclure)
