# Arc : ASCENSION DE DANIEL — Le Chemin au-delà de la Mort 

**Série :** SG-1 · **Code :** `ASC`  
**Portée complète :** S3E20 → S7E02 (2000–2003)  
**Couleur :**  Anciens/Ascension

> Arc le plus métaphysique de SG-1. Daniel découvre l'Ascension via Oma Desala, choisit de s'élever plutôt que de mourir corrompue, observe impuissant depuis le plan ascendé — puis revient amnésique. Sa trajectoire confirme qu'Anubis est un ex-Ancien.
...
```
SHA-02 / ANC-03 (S3) — Kheb révèle l'Ascension
  └→ ASC-01 [Oma Desala / Premier contact / Voie spirituelle]
...
## Arcs Connexes
- **[SHA]** Sha're — ASC-01 et SHA-02 partagent la même scène sur Kheb
- **[ANB]** Anubis — ASC-04 révèle sa nature d'ex-Ancien ; ASC-05 confirme
- **[BAL]** Ba'al — ASC-03 : Daniel témoin impuissant de la torture par Ba'al
- **[ORI]** Ori — Oma Desala participe à l'engagement de l'arc Ori (ANB-07)
- **[MER]** Merlin — Merlin est un Ancien descendu, miroir de Daniel
